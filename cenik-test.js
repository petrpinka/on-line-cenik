(function(){
  ...
  function checkIcon(){<div id="cenik">
  <table id="cenik-test" style="width:100%; border-collapse:collapse; font-size:15px;">
    <!-- thead/tbody nemusí být v HTML, skript je doplní -->
  </table>
</div>
